...
class Rol extends CActiveRecord {
    ...
    public static $ALUMNO = 1;
    public static $PROFESOR = 2;
    public static $ADMINISTRADOR = 3;
    public static $SUPER_USUARIO = 4;
    public static $DISENADOR = 5;
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id_rol', 'required','on'=>'cambiarol'),
            array('nombre', 'length', 'max' => 200),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id_rol, nombre', 'safe', 'on' => 'search'),
        );
    }
